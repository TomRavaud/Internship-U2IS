...
data = np.load("samples/road_t20_v1.npy")

nb_subsamples = data.shape[0]//50

for i in range(nb_subsamples):
    sub_data = data[50*i:50*(i+1)]
    name = "samples/subsamples/road_" + str(i) + ".npy"
    np.save(name, sub_data)
